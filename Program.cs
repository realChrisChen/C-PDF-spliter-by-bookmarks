...
";
        public Register()
        {
            ...
            string fullpath = path + "\\full_license.lic";
            System.IO.File.WriteAllText(fullpath, license);
            RasterSupport.SetLicense(fullpath, "gcxLXptTi5bPbVDDR9E+k4CRC8BLLm0IuN383qJp6jPqoMTYamOe1yuYzHqrCmFEN5zDcumaaCTXpO9GpeGal0wjSKF8nxnu");
        }
    }
